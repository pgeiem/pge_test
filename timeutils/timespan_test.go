...
func TestSegment_Duration(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			end:      time.Date(2023, 10, 1, 1, 0, 0, 0, time.Local),
			expected: time.Hour,
		},
		{
			name:     "HalfHourDuration",
			start:    time.Date(2023, 10, 1, 0, 0, 0, 0, time.Local),
			end:      time.Date(2023, 10, 1, 0, 30, 0, 0, time.Local),
			expected: 30 * time.Minute,
		},
		{
			name:     "ZeroDuration",
			start:    time.Date(2023, 10, 1, 0, 0, 0, 0, time.Local),
			end:      time.Date(2023, 10, 1, 0, 0, 0, 0, time.Local),
			expected: 0,
		},
		{
			name:     "OneDayDuration",
			start:    time.Date(2023, 10, 1, 0, 0, 0, 0, time.Local),
			end:      time.Date(2023, 10, 2, 0, 0, 0, 0, time.Local),
...
func TestSegment_IsWithin(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			time:     time.Date(2023, 10, 1, 0, 30, 0, 0, time.Local),
			expected: true,
		},
		{
			name:     "AfterSegment",
			...
			time:     time.Date(2023, 10, 1, 1, 30, 0, 0, time.Local),
			expected: false,
		},
		{
			name:     "AtSegmentStart",
			...
			time:     time.Date(2023, 10, 1, 0, 0, 0, 0, time.Local),
			expected: true,
		},
		{
			name:     "AtSegmentEnd",
			...
			time:     time.Date(2023, 10, 1, 1, 0, 0, 0, time.Local),
			expected: false,
		},
		{
			name:     "BeforeSegment",
			...
			time:     time.Date(2023, 9, 30, 23, 59, 59, 0, time.Local),
			expected: false,
		},
	}
...
func TestSegment_ToRelativeTimeSpan(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			end:      time.Date(2023, 10, 3, 0, 0, 0, 0, time.Local),
			now:      time.Date(2023, 10, 1, 0, 0, 0, 0, time.Local),
			expected: RelativeTimeSpan{From: 24 * time.Hour, To: 48 * time.Hour},
		},
		{
			name:     "PastSegment",
			start:    time.Date(2023, 9, 30, 0, 0, 0, 0, time.Local),
			end:      time.Date(2023, 10, 1, 0, 0, 0, 0, time.Local),
			now:      time.Date(2023, 10, 2, 0, 0, 0, 0, time.Local),
...
func TestRecurrentSegment_NextAndPrev(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectedNext: AbsTimeSpan{Start: time.Date(2023, 10, 15, 12, 0, 0, 0, time.Local), End: time.Date(2023, 10, 15, 18, 0, 0, 0, time.Local)},
			expectedPrev: AbsTimeSpan{Start: time.Date(2023, 10, 14, 12, 0, 0, 0, time.Local), End: time.Date(2023, 10, 14, 18, 0, 0, 0, time.Local)},
		},
		{
			name:         "AtStartPattern",
			startPattern: "pattern(2023/10/* 12:00:00)",
			endPattern:   "pattern(2023/10/* 18:00:00)",
			now:          time.Date(2023, 10, 15, 12, 0, 0, 0, time.Local),
			expectedNext: AbsTimeSpan{Start: time.Date(2023, 10, 16, 12, 0, 0, 0, time.Local), End: time.Date(2023, 10, 16, 18, 0, 0, 0, time.Local)},
			expectedPrev: AbsTimeSpan{Start: time.Date(2023, 10, 14, 12, 0, 0, 0, time.Local), End: time.Date(2023, 10, 14, 18, 0, 0, 0, time.Local)},
		},
		{
			name:         "AtEndPattern",
			startPattern: "pattern(2023/10/* 12:00:00)",
			endPattern:   "pattern(2023/10/* 18:00:00)",
			now:          time.Date(2023, 10, 15, 18, 0, 0, 0, time.Local),
			expectedNext: AbsTimeSpan{Start: time.Date(2023, 10, 16, 12, 0, 0, 0, time.Local), End: time.Date(2023, 10, 16, 18, 0, 0, 0, time.Local)},
			expectedPrev: AbsTimeSpan{Start: time.Date(2023, 10, 15, 12, 0, 0, 0, time.Local), End: time.Date(2023, 10, 15, 18, 0, 0, 0, time.Local)},
		},
		{
			name:         "MonthlyPattern",
			startPattern: "pattern(2023/*/7 08:00:00)",
			endPattern:   "pattern(2023/*/9 10:00:00)",
			now:          time.Date(2023, 10, 3, 0, 0, 0, 0, time.Local),
			expectedNext: AbsTimeSpan{Start: time.Date(2023, 10, 7, 8, 0, 0, 0, time.Local), End: time.Date(2023, 10, 9, 10, 0, 0, 0, time.Local)},
			expectedPrev: AbsTimeSpan{Start: time.Date(2023, 9, 7, 8, 0, 0, 0, time.Local), End: time.Date(2023, 9, 9, 10, 0, 0, 0, time.Local)},
		},
		{
			name:         "WeeklyPattern",
			startPattern: "pattern(2023/*/* WED 14:35:00)",
			endPattern:   "pattern(2023/*/* WED 16:50:00)",
			now:          time.Date(2023, 4, 1, 0, 0, 0, 0, time.Local),
			expectedNext: AbsTimeSpan{Start: time.Date(2023, 4, 5, 14, 35, 0, 0, time.Local), End: time.Date(2023, 4, 5, 16, 50, 0, 0, time.Local)},
			expectedPrev: AbsTimeSpan{Start: time.Date(2023, 3, 29, 14, 35, 0, 0, time.Local), End: time.Date(2023, 3, 29, 16, 50, 0, 0, time.Local)},
		},
		{
			...
			now:          time.Date(2023, 4, 1, 0, 0, 0, 0, time.Local),
			expectedNext: AbsTimeSpan{Start: time.Date(2023, 4, 5, 14, 35, 0, 0, time.Local), End: time.Date(2023, 4, 5, 16, 05, 0, 0, time.Local)},
			expectedPrev: AbsTimeSpan{Start: time.Date(2023, 3, 29, 14, 35, 0, 0, time.Local), End: time.Date(2023, 3, 29, 16, 05, 0, 0, time.Local)},
		},
		{
			name:         "Periodic8Hours",
			...
			endPattern:   "duration(1h30m)",
			now:          time.Date(2023, 4, 1, 0, 0, 0, 0, time.Local),
			expectedNext: AbsTimeSpan{Start: time.Date(2023, 4, 1, 8, 0, 0, 0, time.Local), End: time.Date(2023, 4, 1, 9, 30, 0, 0, time.Local)},
			expectedPrev: AbsTimeSpan{Start: time.Date(2023, 3, 31, 16, 0, 0, 0, time.Local), End: time.Date(2023, 3, 31, 17, 30, 0, 0, time.Local)},
		},
		{
...
func TestRecurrentSegment_Between(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			startPattern: "pattern(2023/10/* 12:00:00)",
			endPattern:   "pattern(2023/10/* 18:00:00)",
			from:         time.Date(2023, 10, 14, 0, 0, 0, 0, time.Local),
		...
		},
		{
			...
			startPattern: "pattern(2023/*/7 08:00:00)",
			endPattern:   "pattern(2023/*/9 10:00:00)",
			from:         time.Date(2023, 9, 6, 0, 0, 0, 0, time.Local),
		...
		},
		{
			...
			startPattern: "pattern(2023/*/* WED 14:35:00)",
			endPattern:   "pattern(2023/*/* WED 16:50:00)",
			from:         time.Date(2023, 3, 28, 0, 0, 0, 0, time.Local),
			to:           time.Date(2023, 4, 12, 23, 0, 0, 0, time.Local),
			expected: []AbsTimeSpan{
				{Start: time.Date(2023, 3, 29, 14, 35, 0, 0, time.Local), End: time.Date(2023, 3, 29, 16, 50, 0, 0, time.Local)},
				{Start: time.Date(2023, 4, 5, 14, 35, 0, 0, time.Local), End: time.Date(2023, 4, 5, 16, 50, 0, 0, time.Local)},
...
func TestRecurrentSegment_IsWithin(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			startPattern: "pattern(2023/10/* 12:00:00)",
			endPattern:   "pattern(2023/10/* 18:00:00)",
			time:         time.Date(2023, 10, 15, 14, 0, 0, 0, time.Local),
			expected:     true,
			expectedSeg:  AbsTimeSpan{Start: time.Date(2023, 10, 15, 12, 0, 0, 0, time.Local), End: time.Date(2023, 10, 15, 18, 0, 0, 0, time.Local)},
		},
		{
			name:         "BeforeRecurrentSegment",
			startPattern: "pattern(2023/10/* 12:00:00)",
			endPattern:   "pattern(2023/10/* 18:00:00)",
			time:         time.Date(2023, 10, 15, 10, 0, 0, 0, time.Local),
			expected:     false,
			expectedSeg:  AbsTimeSpan{},
		},
		{
		...
		},
		{
			...
			startPattern: "pattern(2023/10/* 12:00:00)",
			endPattern:   "pattern(2023/10/* 18:00:00)",
			time:         time.Date(2023, 10, 15, 12, 0, 0, 0, time.Local),
			expected:     true,
			expectedSeg:  AbsTimeSpan{Start: time.Date(2023, 10, 15, 12, 0, 0, 0, time.Local), End: time.Date(2023, 10, 15, 18, 0, 0, 0, time.Local)},
		},
		{
